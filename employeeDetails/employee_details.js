...
// Function to display the total salaries
...
// Function to find a employee by it's id
...
// Function to greet the employees
function greetEmployees() {
    employees.forEach(employee => {
        alert(`Hi, ${employee.name}`);
    });
}